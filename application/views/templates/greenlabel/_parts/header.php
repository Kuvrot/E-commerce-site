...
<html lang="<?= MY_LANGUAGE_ABBR ?>">
    ...
    <body>
        ...
        <div class="container" style="background-color: #ffede7;">
                        ...
                        <nav>
                            ...
                            <div id="navbar" class="collapse navbar-collapse">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li<?= uri_string() == 'shop' || uri_string() == MY_LANGUAGE_ABBR . '/shop' ? ' class="active"' : '' ?>><a href="<?= LANG_URL . '/shop' ?>"><?= lang('shop') ?> <i class="fa"></i></a>
